  ...
  fetch(url, {
    ...
    .then(function (response) {
      ...
      response.json().then(function (data) {
        ...
        p_repos.innerHTML = `Public Repos : ${data.public_repos}`;

        if (data.twitter_username !== null) {
          twitter.innerHTML = `<a href='https://twitter.com/${data.twitter_username}' target='_blank'><i class="bi bi-twitter"></i></a>`;
